...
<div class="p-6 max-w-2xl">
        ...
        <form method="POST" action="{{ route('categories.store') }}">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-violet-500 focus:ring-1 focus:ring-violet-100">
                </div>
                <div>
                    <label class="block text-sm text-gray-600 mb-1">Category Name</label>
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-violet-500 focus:ring-1 focus:ring-violet-100" required>
                </div>
            </div>
    ...
    <div class="text-sm text-gray-500 mt-6">Products / Category / Create</div>
  </div>
@endsection
