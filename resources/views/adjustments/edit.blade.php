    ...
    <div class="mb-8">
      ...
      <div class="relative" x-data="productSearch()">
        <input x-model="query" @focus="open=true; if(results.length===0) preload();" @input="search" @keydown.enter.prevent="if(results.length){ add(results[0]) }" 
               ...
               class="w-full rounded-lg border-2 border-gray-200 px-3 py-2.5 pl-10 text-sm text-gray-900 placeholder-gray-400 transition-all duration-200 focus:border-violet-500 focus:ring-2 focus:ring-violet-100 focus:outline-none hover:border-gray-300">
