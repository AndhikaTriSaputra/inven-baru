        ...
        <form>
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" value="{{ $brand['name'] ?? '' }}" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-violet-500 focus:ring-1 focus:ring-violet-100">
                </div>
                <div>
                    <label class="block text-sm text-gray-600 mb-1">Brand Description</label>
                    <textarea class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-violet-500 focus:ring-1 focus:ring-violet-100" rows="3">{{ $brand['description'] ?? '' }}</textarea>
                </div>
                <div>
            ...
            <div class="mt-6 flex items-center space-x-3">
                <button type="button" class="px-4 py-2 rounded-full bg-violet-600 text-white hover:bg-violet-500">Update</button>
